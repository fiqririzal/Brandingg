                    ...
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                ...
                                <h6 class="font-extrabold mb-0">{{ number_format($products) }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">Supplier
                                </h6>
                                <h6 class="font-extrabold mb-0">{{ number_format($suppliers) }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start ">
                                <div class="stats-icon green mb-2">
                                    <i class="iconly-bi bi-wallet"></i>
                                </div>
                            </div>
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">Total Pembelian</h6>
                                <h6 class="font-extrabold mb-0">Rp. {{ number_format($cost) }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
